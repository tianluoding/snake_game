...
public class WebSocketServer {
    ...
    public static void startGame(Integer aId, Integer botAId, Integer bId, Integer botBId) {
        User a = userMapper.selectById(aId);
        User b = userMapper.selectById(bId);

        Bot botA = botMapper.selectById(botAId);
        Bot botB = botMapper.selectById(botBId);
