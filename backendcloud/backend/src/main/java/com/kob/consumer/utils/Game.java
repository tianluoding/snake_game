...
public class Game extends Thread {
    ...
    public Game(
        ...
        System.out.println("botAId: " + botAId + " botBId" + botBId);
        playerA = new Player(idA, botAId, botCodeA, rows - 2, 1, new ArrayList<>());
        playerB = new Player(idB, botBId, botCodeB, 1, cols - 2, new ArrayList<>());
    }
    ...
    private void sendBotCode(Player player) {
        ...
        System.out.println("postFor: http://127.0.0.1:3002/bot/add/");
